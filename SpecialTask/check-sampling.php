                                ...
                                <div class="col-lg-6">
                                    <select data-plugin-selectTwo class="form-control populate" name="SelectedUserID"
                                        ...
                                        if ($loggedUserName == 'admin') {
                                            ...
                                            $qryDistUser = $app->getDBConnection()->query("SELECT id, UserName, FullName FROM userinfo WHERE IsActive = 1 AND UserName LIKE '%$dataCollectorNamePrefix%'  AND CompanyID = ? $filterPSUAssignedUser ORDER BY UserName ASC", $loggedUserCompanyID);
                                        } else if ($SuperID) {
